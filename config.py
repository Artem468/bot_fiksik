TOKEN = '5382728154:AAHKu6_JoPI2ZJ7Km73zyoXoDD4x6le7LrY'
...
TIMER_MESSAGE = 'Неккоректный формат ввода. \n' \
                'Пример запроса: /set_timer {часы}h {минуты}min {секунды}sec'
...
GRAPH_MESSAGE = 'Неверный форма ввода. \n' \
                'Проверьте правильность параметров' \
                'Пример написания /graph x**2 -10 10 \n' \
                'Где x**2 - функция \n' \
                '-10 -- минимальнный x \n' \
                '10 -- максимальный x'
